...
<body class="" id="renderPDF">
 ...
 <div id="groups">
                 ...
                 <ul class="nav nav-pills nav-pills-rose" role="tablist" style="padding-top: 5px;">
                  <li class="nav-item">
                      <a class="nav-link active" data-toggle="tab" href="#link1" role="tablist" onclick=selectedType('Point') style="border-radius: 10px;padding: 2px 5px;">
                       <i class="material-icons" style="padding: 1px 0;">adjust</i>
                      </a>
                    </li>

                  <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#link2" role="tablist" onclick=selectedType('LineString') style="border-radius: 10px;padding: 2px 5px;">
                    ...
                    <div class="col-md-2">
                      ...
                      <ul class="nav nav-pills nav-pills-rose nav-pills-icons flex-column" role="tablist">
                        <li class="nav-item" style="padding-bottom: 10px;">
                          <a class="nav-links active" data-toggle="tab" href="#link112" role="tablist"  onclick=deactivateClick()>
